...
/**
 * DTO de entrada para PUT /gastos/{id}
 *
 * Todos los campos son opcionales: solo se actualizan
 * los que vienen con valor no nulo en el request.
 * Esto permite actualizaciones parciales controladas
 * sin sobrescribir datos existentes con null.
 */
@Data
